...
public class NewAdditionalDirectDeposit {
  ...
  public NewAdditionalDirectDeposit() {
  }

  public NewAdditionalDirectDeposit accountType(String accountType) {
  ...
  **/
  ...
  public NewAdditionalDirectDeposit routingNumber(String routingNumber) {
  ...
  **/
  ...
  public NewAdditionalDirectDeposit accountNumber(String accountNumber) {
  ...
  **/
  ...
  public NewAdditionalDirectDeposit amountType(String amountType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount type to indicate the context of the amount. Common values are *F* (FLAT), *F-* (Net Minus), *P* (Percent). <br  /> Max length: 5<br /><small>new with Web Link 16.6 release</small>")
  ...
  public NewAdditionalDirectDeposit amount(Double amount) {
  ...
  public NewAdditionalDirectDeposit amount(Integer amount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount value to be deposited to the account.<br  />Decimal (12,2)<br /><small>new with Web Link 16.6 release</small>")
  ...
  public NewAdditionalDirectDeposit blockSpecial(Boolean blockSpecial) {
  ...
  **/
  ...
  public NewAdditionalDirectDeposit nameOnAccount(String nameOnAccount) {
  ...
  **/
  ...
  public NewAdditionalDirectDeposit skipPreNote(Boolean skipPreNote) {
  ...
  **/
  ...
  public NewAdditionalDirectDeposit preNoteDate(LocalDate preNoteDate) {
  ...
  **/
   ...
   * @return the NewAdditionalDirectDeposit instance itself
   */
  public NewAdditionalDirectDeposit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NewAdditionalDirectDeposit newAdditionalDirectDeposit = (NewAdditionalDirectDeposit) o;
    return Objects.equals(this.accountType, newAdditionalDirectDeposit.accountType) &&
        Objects.equals(this.routingNumber, newAdditionalDirectDeposit.routingNumber) &&
        Objects.equals(this.accountNumber, newAdditionalDirectDeposit.accountNumber) &&
        Objects.equals(this.amountType, newAdditionalDirectDeposit.amountType) &&
        Objects.equals(this.amount, newAdditionalDirectDeposit.amount) &&
        Objects.equals(this.blockSpecial, newAdditionalDirectDeposit.blockSpecial) &&
        Objects.equals(this.nameOnAccount, newAdditionalDirectDeposit.nameOnAccount) &&
        Objects.equals(this.skipPreNote, newAdditionalDirectDeposit.skipPreNote) &&
        Objects.equals(this.preNoteDate, newAdditionalDirectDeposit.preNoteDate)&&
        Objects.equals(this.additionalProperties, newAdditionalDirectDeposit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountType, routingNumber, accountNumber, amountType, amount, blockSpecial, nameOnAccount, skipPreNote, preNoteDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewAdditionalDirectDeposit {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewAdditionalDirectDeposit
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NewAdditionalDirectDeposit.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewAdditionalDirectDeposit is not found in the empty JSON string", NewAdditionalDirectDeposit.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewAdditionalDirectDeposit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewAdditionalDirectDeposit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewAdditionalDirectDeposit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewAdditionalDirectDeposit.class));

       return (TypeAdapter<T>) new TypeAdapter<NewAdditionalDirectDeposit>() {
           @Override
           public void write(JsonWriter out, NewAdditionalDirectDeposit value) throws IOException {
           ...
           @Override
           public NewAdditionalDirectDeposit read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NewAdditionalDirectDeposit instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NewAdditionalDirectDeposit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewAdditionalDirectDeposit
  * @throws IOException if the JSON string is invalid with respect to NewAdditionalDirectDeposit
  */
  public static NewAdditionalDirectDeposit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewAdditionalDirectDeposit.class);
  }

 /**
  * Convert an instance of NewAdditionalDirectDeposit to an JSON string
  *
  * @return JSON string
  */
