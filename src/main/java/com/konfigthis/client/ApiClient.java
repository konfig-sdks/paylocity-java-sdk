...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://apisandbox.paylocity.com/api";
    private String tokenUrl = "https://api.paylocity.com/IdentityServer/connect/token";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("paylocity_auth", oauth);
        return oauth;
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apisandbox.paylocity.com/api)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://api.paylocity.com/IdentityServer/connect/token)
     * @return An instance of OkHttpClient
     */
